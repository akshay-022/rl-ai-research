"""
Memory Optimization Task Evaluation Runner

Run this file to test the memory optimization task with an agent.
"""
...
MAX_TOKENS = 8000  # Optimized code can be lengthy
    ...
    for step in range(max_steps):
        ...
        if has_tool_use:
            ...
            if submitted_answer is not None:
                if verbose:
                    print(f"\n{'='*60}")
                    print("SUBMITTED MEMORY-OPTIMIZED TRAINING SCRIPT")
                    print("="*60)
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Run memory optimization task evaluation")
